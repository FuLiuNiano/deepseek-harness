...
export const en = {
  ...
  npmPackage: 'npm package or supported GitHub plugin',
  install: 'Install',
  installed: 'Installed',
  noPlugins: 'No Desktop plugins are installed.',
  remove: 'Remove',
  update: 'Update',
  targetVersion: 'Enter the target version for {name}, or its supported GitHub spec',
...
export const zh = {
  ...
  npmPackage: 'npm 包或支持的 GitHub 插件地址',
  install: '安装',
  installed: '已安装',
  noPlugins: '还没有安装桌面插件。',
  remove: '移除',
  update: '更新',
  targetVersion: '输入 {name} 的目标版本号，或支持的 GitHub 地址',
  removing: '正在移除 {name}…',
  updating: '正在更新 {name}…',
